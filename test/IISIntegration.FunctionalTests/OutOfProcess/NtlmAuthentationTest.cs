    ...
    public class NtlmAuthenticationTests : LoggedTest
    {
        ...
        public static TestMatrix TestVariants
            => TestMatrix.ForServers(ServerType.IISExpress)
                ...
                .WithAllAncmVersions()
                .Skip("https://github.com/aspnet/IISIntegration/issues/831", v =>
                    v.ApplicationType == ApplicationType.Standalone && v.AncmVersion == AncmVersion.AspNetCoreModuleV2);

        [WorkaroundConditionalTheory]
